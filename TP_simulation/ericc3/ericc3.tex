...
\begin{itemize}
\item La structure de l'asservissement est numérique. Les grandeurs numériques sont représentées avec un exposant $*$.
...
\item Le système comporte un correcteur PID (Proportionnel Intégral Dérivé). Ici on ne considèrera que le correcteur Proportionnel (de gain \textbf{$K_p$}). Ainsi on prendra $K_i=0$ et $K_d=0$.
...
\question{Compléter le schéma bloc "TP$\_$Ericc3$\_$Modele$\_$Matlab$\_$eleve.slx" pour modéliser le système asservi en boucle fermée. 
\begin{itemize}
